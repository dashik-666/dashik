          ...
          <div class="flex items-end space-x-6">
            ...
            <div>
              ...
              <div class="mt-3 whitespace-nowrap">
                <el-link href="https://gitee.com/youlaiorg/叨叨电竞" target="_blank">
                  <div class="i-svg:gitee text-lg color-#F76560" />
                </el-link>
                <el-divider direction="vertical" />
                <el-link href="https://github.com/youlaitech/叨叨电竞" target="_blank">
                  <div class="i-svg:github text-lg color-#4080FF" />
                </el-link>
                <el-divider direction="vertical" />
                <el-link href="https://gitcode.com/youlai/叨叨电竞" target="_blank">
          ...
          <template #header>
            <div class="flex-x-between">
              ...
              <el-link
                type="primary"
                underline="never"
                href="https://gitee.com/youlaiorg/叨叨电竞/releases"
                target="_blank"
              >
                完整记录
...
const vesionList = ref<VersionItem[]>([
  {
    ...
    content: "布局重写，代码规范重构。",
    link: "https://gitee.com/youlaiorg/叨叨电竞/releases",
    tag: "里程碑",
  },
  {
    id: "2",
...
const fetchVisitStatsData = () => {
  // 使用模拟数据替代LogAPI
  const mockData: VisitStatsVO = {
    pvCount: 12580,
    uvCount: 8960,
    ipCount: 7420
  };
  visitStatsData.value = mockData;
...
const fetchVisitTrendData = () => {
  ...
  // 使用模拟数据替代LogAPI
  const mockTrendData: VisitTrendVO[] = Array.from({ length: visitTrendDateRange.value }, (_, i) => ({
    date: dayjs().subtract(visitTrendDateRange.value - 1 - i, 'day').format('YYYY-MM-DD'),
    pvCount: Math.floor(Math.random() * 1000) + 500,
    uvCount: Math.floor(Math.random() * 800) + 300,
    ipCount: Math.floor(Math.random() * 600) + 200
  }));
  updateVisitTrendChartOptions(mockTrendData);
};
