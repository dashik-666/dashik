...
export const AuthStorage = {
  ...
  setTokens(accessToken: string, refreshToken: string, rememberMe: boolean): void {
    console.log('保存token:', { accessToken, refreshToken, rememberMe });
    ...
    console.log('token保存完成，验证accessToken:', this.getAccessToken());
    console.log('token保存完成，验证refreshToken:', this.getRefreshToken());
  },
